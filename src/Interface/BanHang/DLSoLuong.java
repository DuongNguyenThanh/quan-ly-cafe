...
public class DLSoLuong extends javax.swing.JDialog {
    ...
    private void Fill(){
        arrThucDon = cn.GetFoodByMa(mamon);
        txtSl.setText("1");
        lblban.setText(TenBan + " ");
        
        lblTenMon.setText(arrThucDon.get(0).getNameFood());
        txtgia.setText(String.valueOf(arrThucDon.get(0).getPrice()));
    }
    /**
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(mon != null){
            ...
            cthd.SetMaMon(Integer.toString(mamon));
