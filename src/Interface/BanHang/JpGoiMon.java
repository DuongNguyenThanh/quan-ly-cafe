                ...
                pn[i].add(lbl).addMouseListener(new MouseAdapter() {
                  @Override
                    public void mouseClicked(MouseEvent e){
                        int qs;
                        ArrayList<Food> td = cn.GetFoodByMa(Integer.parseInt(e.getComponent().getName()));
                        
                        qs = JOptionPane.showConfirmDialog(null, "Hủy món: "+td.get(0).getNameFood()+" ?", "Hủy món", JOptionPane.YES_NO_OPTION);
