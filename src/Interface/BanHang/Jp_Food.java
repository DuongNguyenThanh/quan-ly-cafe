...
public class Jp_Food extends javax.swing.JPanel {
    ConnectSQL cn = new ConnectSQL();
    /**
     * Creates new form Jp_Food
     */
    ...
    tenban;
    public int maban;
    public ArrayList<Food> arrdsmon;
    NumberFormat chuyentien = new DecimalFormat("#,###,###");
    public static Jp_Food td;
    public void FillLoai(){
        jpChonMon.setLayout(new  FlowLayout(FlowLayout.CENTER));
        ArrayList<Food> arrThucDon = cn.GetFood();
        jpChonMon.removeAll();
        jpChonMon.updateUI();
        if(arrThucDon != null){
            ...
            for(int i=0;i<arrThucDon.size();i++){
                pn[i] = new JPanel();
                pn[i].setName(Integer.toString(arrThucDon.get(i).getIDFood()));
                ...
                pn[i].add(new JLabel(arrThucDon.get(i).getNameFood())).setFont(new java.awt.Font("Tahoma", 1, 12));
                pn[i].add(new JLabel(String.valueOf(chuyentien.format(arrThucDon.get(i).getPrice()))+" VNĐ / " + arrThucDon.get(i).getDVT()))
