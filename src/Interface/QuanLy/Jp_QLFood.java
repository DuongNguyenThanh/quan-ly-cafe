 ...
 * @author ThangIKCU
 */
public class Jp_QLFood extends javax.swing.JPanel {
    ConnectSQL cn = new ConnectSQL();
    
    /**
     * Creates new form Jp_QLFood
     */
    public static Jp_QLFood td;
    public Jp_QLFood() {
        td = this;
        initComponents();
        FillTable();
    ...
    public void FillTable() {
        ArrayList<Food> arrTable = cn.GetFood();
        DefaultTableModel tbmodel = new DefaultTableModel();

        tbmodel.addColumn("Mã món");
        tbmodel.addColumn("Tên món");
        tbmodel.addColumn("Đơn giá");
        tbmodel.addColumn("Đơn vị");

        if (arrTable != null) {
            int somon = 0;
            for (Food td : arrTable) {
                somon++;
                tbmodel.addRow(new Object[]{td.getIDFood(), td.getNameFood(), td.getPrice(), td.getDVT()});
            }
    ...
    private void bntSuaMonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntSuaMonActionPerformed
        ...
        if(select < 0){
            ...
            int mamon = (Integer) tbBan.getValueAt(select, 0);
    ...
    private void bntXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntXoaActionPerformed
        ...
        if (selectedRows.length <= 0) {
            ...
            for (int i : selectedRows) {
                ...
                ListMaBan.add(ma);
                String tenTable = (String) tbBan.getValueAt(i, 1);
            ...
            if (qs == JOptionPane.YES_OPTION) {
                boolean xoa = cn.DeleteFood(ListMaBan);
                if (xoa == true) {
                    FillTable();
                    try{
                        Jp_Food.td.FillLoai();
    ...
    private void txttimKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txttimKeyReleased
        ...
        ArrayList<Food> arrTable = cn.SearchMon(txttim.getText());
        if(arrTable != null){
            DefaultTableModel tbmodel = new DefaultTableModel();
