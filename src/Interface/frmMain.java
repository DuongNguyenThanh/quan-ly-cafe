...
import Interface.QuanLy.Jp_QuanLy;
import Interface.Setting.Jp_Setting;
import Models.Ban;
...
public final class frmMain extends javax.swing.JFrame {
     ...
     */
    public NhanVien loadtaikhoan(String user, String pass){
    ...
    public frmMain() {
        ...
        clock.start(); 
        txtqtv.setText(Run.tk.getIdStaff());
        if(!Run.tk.getPos().equalsIgnoreCase("quản lý") && !Run.tk.getPos().equalsIgnoreCase("admin"))
        {
    ...
    private void btnthoatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnthoatActionPerformed
        ...
        int kq=JOptionPane.showConfirmDialog(null, "Đăng xuất khỏi tài khoản " +Run.tk.getIdStaff()+ "?","FBI Warning",JOptionPane.YES_NO_OPTION);
        if(kq==0)
        {
